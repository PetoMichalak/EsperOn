...
public class AggSvcGroupByNoReclaimAccessOnlyImpl implements AggregationService, AggregationResultFuture {
    ...
    public void applyEnter(com.espertech.esper.client.EventBean[] eventsPerStream, Object groupKey, ExprEvaluatorContext exprEvaluatorContext) {
    ...
    public void applyLeave(com.espertech.esper.client.EventBean[] eventsPerStream, Object groupKey, ExprEvaluatorContext exprEvaluatorContext) {
        if (InstrumentationHelper.ENABLED) {
