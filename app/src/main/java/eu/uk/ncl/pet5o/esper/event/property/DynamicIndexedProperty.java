...
import eu.uk.ncl.pet5o.esper.event.arr.ObjectArrayIndexedPropertyGetter;
import eu.uk.ncl.pet5o.esper.event.bean.BeanEventType;
import eu.uk.ncl.pet5o.esper.event.bean.DynamicIndexedPropertyGetter;
import eu.uk.ncl.pet5o.esper.event.map.MapEventPropertyGetter;
import eu.uk.ncl.pet5o.esper.event.map.MapIndexedPropertyGetter;
import eu.uk.ncl.pet5o.esper.event.xml.BaseXMLEventType;
import eu.uk.ncl.pet5o.esper.event.xml.DOMIndexedGetter;
