...
public class MapNestedEntryPropertyGetterObjectArray extends MapNestedEntryPropertyGetterBase {
    ...
    public Object handleNestedValue(Object value) {
        if (!(value instanceof Object[])) {
            if (value instanceof com.espertech.esper.client.EventBean) {
                return arrayGetter.get((com.espertech.esper.client.EventBean) value);
            }
            return null;
        }
    ...
    public Object handleNestedValueFragment(Object value) {
        if (!(value instanceof Object[])) {
            if (value instanceof com.espertech.esper.client.EventBean) {
                return arrayGetter.getFragment((com.espertech.esper.client.EventBean) value);
            }
            return null;
        }

        // If the map does not contain the key, this is allowed and represented as null
        com.espertech.esper.client.EventBean eventBean = eventAdapterService.adapterForTypedObjectArray((Object[]) value, fragmentType);
