...
import eu.uk.ncl.pet5o.esper.event.bean.NestedPropertyGetter;
import eu.uk.ncl.pet5o.esper.event.map.MapEventPropertyGetter;
import eu.uk.ncl.pet5o.esper.event.map.MapNestedPropertyGetterMapOnly;
import eu.uk.ncl.pet5o.esper.event.map.MapNestedPropertyGetterMixedType;
