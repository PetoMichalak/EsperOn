...
import eu.uk.ncl.pet5o.esper.event.arr.ObjectArrayArrayPOJOEntryIndexedPropertyGetter;
import eu.uk.ncl.pet5o.esper.event.arr.ObjectArrayArrayPropertyGetter;
import eu.uk.ncl.pet5o.esper.event.arr.ObjectArrayEventPropertyGetterAndIndexed;
import eu.uk.ncl.pet5o.esper.event.arr.ObjectArrayEventType;
import eu.uk.ncl.pet5o.esper.event.bean.*;
import eu.uk.ncl.pet5o.esper.event.map.MapArrayPOJOEntryIndexedPropertyGetter;
import eu.uk.ncl.pet5o.esper.event.map.MapArrayPropertyGetter;
import eu.uk.ncl.pet5o.esper.event.map.MapEventPropertyGetterAndIndexed;
