...
import eu.uk.ncl.pet5o.esper.event.bean.InternalEventPropDescriptor;
import eu.uk.ncl.pet5o.esper.event.map.MapEventBeanPropertyGetter;
import eu.uk.ncl.pet5o.esper.event.map.MapEventPropertyGetter;
import eu.uk.ncl.pet5o.esper.event.map.MapPropertyGetterDefaultNoFragment;
