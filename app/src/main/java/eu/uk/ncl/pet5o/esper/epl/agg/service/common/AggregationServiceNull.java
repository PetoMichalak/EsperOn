...
public class AggregationServiceNull implements AggregationService {
    ...
    public void applyEnter(com.espertech.esper.client.EventBean[] eventsPerStream,
                           Object optionalGroupKeyPerRow,
                           ExprEvaluatorContext exprEvaluatorContext) {
    }

    public void applyLeave(com.espertech.esper.client.EventBean[] eventsPerStream,
                           Object optionalGroupKeyPerRow,
                           ExprEvaluatorContext exprEvaluatorContext) {
    }
