...
public interface ResultSetProcessorRowForAllOutputAllHelper extends ResultSetProcessorOutputHelper {
    ...
    UniformPair<com.espertech.esper.client.EventBean[]> outputView(boolean isGenerateSynthetic);

    UniformPair<com.espertech.esper.client.EventBean[]> outputJoin(boolean isGenerateSynthetic);
