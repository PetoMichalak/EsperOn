...
public interface ResultSetProcessorRowForAllOutputAllHelper extends ResultSetProcessorOutputHelper {
    ...
    UniformPair<eu.uk.ncl.pet5o.esper.client.EventBean[]> outputView(boolean isGenerateSynthetic);

    UniformPair<eu.uk.ncl.pet5o.esper.client.EventBean[]> outputJoin(boolean isGenerateSynthetic);
