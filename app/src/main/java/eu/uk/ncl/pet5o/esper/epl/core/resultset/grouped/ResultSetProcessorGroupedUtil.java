...
public class ResultSetProcessorGroupedUtil {
     ...
     */
    public static void applyAggViewResultKeyedView(AggregationService aggregationService, AgentInstanceContext agentInstanceContext, com.espertech.esper.client.EventBean[] newData, Object[] newDataMultiKey, com.espertech.esper.client.EventBean[] oldData, Object[] oldDataMultiKey, com.espertech.esper.client.EventBean[] eventsPerStream) {
        // update aggregates
        if (newData != null) {
    ...
    public static CodegenMethodNode generateGroupKeySingleCodegen(ExprNode[] groupKeyExpressions, CodegenClassScope classScope, CodegenInstanceAux instance) {
        ...
        return instance.getMethods().addMethod(Object.class, "generateGroupKeySingle", CodegenNamedParam.from(com.espertech.esper.client.EventBean[].class, NAME_EPS, boolean.class, NAME_ISNEWDATA), ResultSetProcessorUtil.class, classScope, code);
    }
    ...
    public static CodegenMethodNode generateGroupKeyArrayViewCodegen(ExprNode[] groupKeyExpressions, CodegenClassScope classScope, CodegenInstanceAux instance) {
        ...
        return instance.getMethods().addMethod(Object[].class, "generateGroupKeyArrayView", CodegenNamedParam.from(com.espertech.esper.client.EventBean[].class, "events", boolean.class, NAME_ISNEWDATA), ResultSetProcessorRowPerGroup.class, classScope, code);
    }
    ...
    public static CodegenMethodNode generateGroupKeyArrayJoinCodegen(ExprNode[] groupKeyExpressions, CodegenClassScope classScope, CodegenInstanceAux instance) {
        ...
        Consumer<CodegenMethodNode> code = method -> {
            method.getBlock().ifCondition(exprDotMethod(ref("resultSet"), "isEmpty")).blockReturn(constantNull())
                    ...
                    .assignArrayElement("keys", ref("count"), localMethod(generateGroupKeySingle, cast(com.espertech.esper.client.EventBean[].class, exprDotMethod(ref("eventsPerStream"), "getArray")), REF_ISNEWDATA))
                    .increment("count")
                    .blockEnd()
