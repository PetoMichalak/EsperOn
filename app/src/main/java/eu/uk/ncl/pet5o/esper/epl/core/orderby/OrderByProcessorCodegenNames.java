...
public class OrderByProcessorCodegenNames {
    ...
    final static List<CodegenNamedParam> SORTPLAIN_PARAMS = CodegenNamedParam.from(com.espertech.esper.client.EventBean[].class, REF_OUTGOINGEVENTS.getRef(),
            com.espertech.esper.client.EventBean[][].class, REF_GENERATINGEVENTS.getRef(),
    ...
    final static List<CodegenNamedParam> SORTWGROUPKEYS_PARAMS = CodegenNamedParam.from(
            com.espertech.esper.client.EventBean[].class, REF_OUTGOINGEVENTS.getRef(),
            com.espertech.esper.client.EventBean[][].class, REF_GENERATINGEVENTS.getRef(),
    ...
    final static List<CodegenNamedParam> SORTTWOKEYS_PARAMS = CodegenNamedParam.from(
            com.espertech.esper.client.EventBean.class, REF_ORDERFIRSTEVENT.getRef(),
            Object.class, REF_ORDERFIRSTSORTKEY.getRef(),
            com.espertech.esper.client.EventBean.class, REF_ORDERSECONDEVENT.getRef(),
