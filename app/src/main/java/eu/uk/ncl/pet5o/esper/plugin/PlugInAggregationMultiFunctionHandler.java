...
public interface PlugInAggregationMultiFunctionHandler {
     ...
     * </p>
     * <p>
     * Use {@link eu.uk.ncl.pet5o.esper.epl.rettype.EPTypeHelper#singleValue(Class)} (Class)} to indicate that the accessor
     * returns a single value. The accessor should return the single value upon invocation of
     * {@link AggregationAccessor#getValue(eu.uk.ncl.pet5o.esper.epl.agg.access.AggregationState, eu.uk.ncl.pet5o.esper.client.EventBean[], boolean, eu.uk.ncl.pet5o.esper.epl.expression.core.ExprEvaluatorContext)}.
     * The accessor should return a null value for all other accessor methods.
     * </p>
     * <p>
     * Use {@link eu.uk.ncl.pet5o.esper.epl.rettype.EPTypeHelper#collectionOfEvents(eu.uk.ncl.pet5o.esper.client.EventType)} to indicate that the accessor
     * returns a collection of events. The accessor should return a value in
     * {@link AggregationAccessor#getEnumerableEvents(eu.uk.ncl.pet5o.esper.epl.agg.access.AggregationState, eu.uk.ncl.pet5o.esper.client.EventBean[], boolean, eu.uk.ncl.pet5o.esper.epl.expression.core.ExprEvaluatorContext)}.
     * The accessor can also return an array of underlying event objects in
     * {@link AggregationAccessor#getValue(eu.uk.ncl.pet5o.esper.epl.agg.access.AggregationState, eu.uk.ncl.pet5o.esper.client.EventBean[], boolean, eu.uk.ncl.pet5o.esper.epl.expression.core.ExprEvaluatorContext)}.
     * The accessor should return a null value for all other accessor methods.
     * </p>
     * <p>
     * Use {@link eu.uk.ncl.pet5o.esper.epl.rettype.EPTypeHelper#singleEvent(eu.uk.ncl.pet5o.esper.client.EventType)} to indicate that the accessor
     * returns a single event. The accessor should return a value in
     * {@link AggregationAccessor#getEnumerableEvent(eu.uk.ncl.pet5o.esper.epl.agg.access.AggregationState, eu.uk.ncl.pet5o.esper.client.EventBean[], boolean, eu.uk.ncl.pet5o.esper.epl.expression.core.ExprEvaluatorContext)}.
     * The accessor can also return the underlying event object in
     * {@link AggregationAccessor#getValue(eu.uk.ncl.pet5o.esper.epl.agg.access.AggregationState, eu.uk.ncl.pet5o.esper.client.EventBean[], boolean, eu.uk.ncl.pet5o.esper.epl.expression.core.ExprEvaluatorContext)}.
     * The accessor should return a null value for all other accessor methods.
     * </p>
     * <p>
     * Use {@link eu.uk.ncl.pet5o.esper.epl.rettype.EPTypeHelper#collectionOfSingleValue(Class)} to indicate that the accessor
     * returns a collection of single values (scalar, object etc.). The accessor should return a java.util.Collection in
     * {@link AggregationAccessor#getValue(eu.uk.ncl.pet5o.esper.epl.agg.access.AggregationState, eu.uk.ncl.pet5o.esper.client.EventBean[], boolean, eu.uk.ncl.pet5o.esper.epl.expression.core.ExprEvaluatorContext)}.
     * The accessor should return a null value for all other accessor methods.
     * </p>
     * <p>
     * Use {@link eu.uk.ncl.pet5o.esper.epl.rettype.EPTypeHelper#array(Class)} to indicate that the accessor
