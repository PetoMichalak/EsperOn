...
import eu.uk.ncl.pet5o.esper.core.context.activator.ViewableActivatorStreamReuseView;
...
import eu.uk.ncl.pet5o.esper.epl.view.FilterExprView;
...
import eu.uk.ncl.pet5o.esper.rowregex.EventRowRegexHelper;
import eu.uk.ncl.pet5o.esper.rowregex.EventRowRegexNFAViewService;
...
import eu.uk.ncl.pet5o.esper.view.internal.PatternRemoveDispatchView;
import eu.uk.ncl.pet5o.esper.view.internal.PriorEventViewFactory;
import eu.uk.ncl.pet5o.esper.view.internal.SingleStreamDispatchView;
...
public class StatementAgentInstanceFactorySelect extends StatementAgentInstanceFactoryBase {
    ...
    private Viewable handleSimpleSelect(Viewable view,
        ...
        eu.uk.ncl.pet5o.esper.view.View selectView = outputProcessViewFactory.makeView(resultSetProcessor, agentInstanceContext);
