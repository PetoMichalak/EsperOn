...
public class SelectExprProcessorEvalStreamInsertTable implements ExprForge, ExprEvaluator, ExprNodeRenderable {
    ...
    public Object evaluate(com.espertech.esper.client.EventBean[] eventsPerStream, boolean isNewData, ExprEvaluatorContext exprEvaluatorContext) {
        ...
        com.espertech.esper.client.EventBean event = convertToTableEvent(streamNum, tableMetadata.getEventToPublic(), eventsPerStream, isNewData, exprEvaluatorContext);
        if (InstrumentationHelper.ENABLED) {
     ...
     * @return event
     */
    public static com.espertech.esper.client.EventBean convertToTableEvent(int streamNum, TableMetadataInternalEventToPublic eventToPublic, com.espertech.esper.client.EventBean[] eventsPerStream, boolean isNewData, ExprEvaluatorContext exprEvaluatorContext) {
