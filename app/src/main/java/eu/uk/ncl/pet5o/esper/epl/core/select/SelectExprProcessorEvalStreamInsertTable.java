...
public class SelectExprProcessorEvalStreamInsertTable implements ExprForge, ExprEvaluator, ExprNodeRenderable {
    ...
    public Object evaluate(eu.uk.ncl.pet5o.esper.client.EventBean[] eventsPerStream, boolean isNewData, ExprEvaluatorContext exprEvaluatorContext) {
        ...
        eu.uk.ncl.pet5o.esper.client.EventBean event = convertToTableEvent(streamNum, tableMetadata.getEventToPublic(), eventsPerStream, isNewData, exprEvaluatorContext);
        if (InstrumentationHelper.ENABLED) {
     ...
     * @return event
     */
    public static eu.uk.ncl.pet5o.esper.client.EventBean convertToTableEvent(int streamNum, TableMetadataInternalEventToPublic eventToPublic, eu.uk.ncl.pet5o.esper.client.EventBean[] eventsPerStream, boolean isNewData, ExprEvaluatorContext exprEvaluatorContext) {
